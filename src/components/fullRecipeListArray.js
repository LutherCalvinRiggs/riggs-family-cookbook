export const fullRecipeListArray = [
  ...
  },
  {
    ...
    recipeDirections: [
      ...
      {
        stepNumber: 2,
        direction: "Lightly oil your fingers. Carefully lift the skin away from the breast and legs of the chicken, then slide your fingers under the skin to lossen it. Fill a piping bag with the stuffing and squeeze this under the skin in an even layer."
      },
      {
        stepNumber: 3,
      ...
      {
        stepNumber: 4,
        direction: "Transfer the chicken to a plate or board, tipping any juices from the cavity into the roasting tin. Cover the chicken with foil and leave it to rest for 20 minutes."
      },
      {
        stepNumber: 5,
  ...
  },
  {
    ...
    recipeIngredientList: [
      ...
      },
      {
        ingredientNumber: 8,
        amount: "300 g",
        ingredient: "Dried egg pasta, such as tagliatelle",
        preparation: ""
      },
      {
        ingredientNumber: 9,
    ...
    recipeDirections: [
      ...
      {
        stepNumber: 3,
        direction: "Meanwhile, bring a pan of salted water to the boil and cook the pasta according to the packet instructions."
      },
      {
        stepNumber: 4,
        direction: "Drain the pasta, but do not rinse it, then tip it back in the pan. Stir in the mushroom purée and check the seasoning. Serve at once, topped with the reserved whole mushrooms."
  ...
  },
  {
    ...
    recipeDirections: [
      ...
      {
        stepNumber: 2,
        direction: "Roast the tomatoes in the oven for 1 hour, stirring them a couple of times. The tomatoes should take on some charred edges and give off a lot of moisture. Pour everything, juices and all, into a pan, then add the anchovies and stock and place over a medium heat."
      },
      {
        stepNumber: 3,
        direction: "Season with salt and pepper, bring to a simmer and cook for 20 minutes, then blitz the soup in a blender or food processor until smooth. For a really silky finish, pass the soup through a fine sieve."
  ...
  },
  {
    ...
    recipeIngredientList: [
      ...
      },
      {
        ingredientNumber: 7,
        amount: "",
        ingredient: "Pinch of piment d'Espelette or chili flakes",
        preparation: ""
      }
    ],
    recipeDirections: [
      ...
      {
        stepNumber: 4,
        direction: "Mix the lemon juice with the remaining oil, the syrup from preparing the lemon peel and a pinch of salt. Drizzle this over the grilled broccoli, then scatter the almonds on top, along with the cooked lemon peel. Dust with a little piment d'Espelette or some chilli flakes before serving."
      }
    ],
    recipeImage: "",
    cookbookTitle: "The French Revolution",
  ...
  },
  {
    ...
    recipeIngredientList: [
      ...
      },
      {
        ingredientNumber: 6,
        amount: "1",
        ingredient: "Juice of lemon (optional)",
        preparation: ""
      },
      {
        ingredientNumber: 7,
      ...
      },
      {
        ingredientNumber: 9,
        amount: "",
        ingredient: "Salt & freshly ground black pepper",
        preparation: ""
      }
    ],
    recipeDirections: [
